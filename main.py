...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    #upsample to 4x4. padding must be the same as the output
...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    train_op = optomizer.minimize(cross_entropy_loss)
...
def run():
    ...
    with tf.Session(config = config) as sess:
        ...
        final_layer = layers(layer_3_out, layer_4_out, layer_7_out, num_classes)
...
=======
        epochs = 25
>>>>>>> 28ed66118ba592d68be9b7d28455998dfeccb57e
        batch_size = 5
